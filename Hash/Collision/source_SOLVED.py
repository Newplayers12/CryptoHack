...
def pad(data):
    padding_len = (BLOCK_SIZE - len(data)) % BLOCK_SIZE # pad cho đến khi chia hết cho 32
    return data + bytes([padding_len]*padding_len) # padding thêm các bytes là độ dài padding
